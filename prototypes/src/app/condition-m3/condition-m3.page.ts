...
@Component({
  selector: 'app-condition-m3',
  templateUrl: './condition-m3.page.html',
  styleUrls: ['./condition-m3.page.scss'],
})
export class ConditionM3Page implements OnInit {
  ...
  ionViewDidEnter() {
    this.isAgree = true;
    this.isPay = this.memory.isPayM3;
